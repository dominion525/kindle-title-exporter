...
#### ZRAWPUBLICATIONDATE
- **型**: INTEGER
- **説明**: 出版日（Core Data形式タイムスタンプ）
- **形式**: 2001-01-01 00:00:00 UTCからの秒数
- **例**: `1414863211`
- **変換**: `timestamp + 978307200 = Unix timestamp`
...
Core Data形式のタイムスタンプは、2001-01-01 00:00:00 UTCからの秒数です。
...
BLOB項目は直接読み取ることができません。特に`ZSYNCMETADATAATTRIBUTES`は重要な情報を含むため、plistデコーダーが必要です。
